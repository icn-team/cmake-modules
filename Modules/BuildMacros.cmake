...
macro (build_module module)
  cmake_parse_arguments(ARG
    ""
    "COMPONENT;"
    "SOURCES;LINK_LIBRARIES;OBJECT_LIBRARIES;INSTALL_HEADERS;DEPENDS;INCLUDE_DIRS;DEFINITIONS;INSTALL_RPATH;HEADER_ROOT_DIR;LIBRARY_ROOT_DIR;INSTALL_FULL_PATH_DIR;COMPILE_OPTIONS;VERSION"
    ${ARGN}
  )
  ...
  build_library(${module}
    ...
    OBJECT_LIBRARIES ${ARG_OBJECT_LIBRARIES}
